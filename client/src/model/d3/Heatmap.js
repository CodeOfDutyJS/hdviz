...
function drawTargetRows(cluster, cols, margin) {
...
function heatmap({
  ...
  drawTargetRows(cluster, targetCols, margin);
  drawColorScale(c, [-3, 3], width + (targetCols.length * 25) + 50, height - 100, 100, 25, 'Standard Deviation');
